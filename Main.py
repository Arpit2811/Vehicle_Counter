...
classNames = ["person", "bicycle", "car", "motorbike", "aeroplane", "bus", "train", "truck", "boat",
            ...
            "toaster","teddy bear", "hair drier", "toothbrush" , "sink", "refrigerator", "book", "clock", "vase"
              ]

# Video source
cap = cv2.VideoCapture("../Videos/Vechile.mp4")
...
while True:
    ...
    for result in resultsTracker:
        ...
        # Counting condition (corrected)
        if limits[0] < cx < limits[2] and limits[1] - 20 < cy < limits[1] + 20:
            if totalCount.count(Id) == 0:
                totalCount.append(Id)

    # Display total count
    cvzone.putTextRect(img, f'Count: {len(totalCount)}', (50, 50), scale=2, thickness=3, colorR=(0, 200, 0))
